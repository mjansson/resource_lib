/* source.h  -  Resource library  -  Public Domain  -  2014 Mattias Jansson
 *
...
The iteration can be aborted by the reduce function returning a marker value of -1 */
RESOURCE_API void
resource_source_map_reduce(resource_source_t* source, hashmap_t* map, void* data, resource_source_map_reduce_fn reduce);
