...
RESOURCE_API bool  resource_compile_need_update_static( const uuid_t uuid );
RESOURCE_API bool  resource_compile_need_update_dynamic( const uuid_t uuid );
RESOURCE_API int   resource_compile_update_static( const uuid_t uuid );
RESOURCE_API int   resource_compile_update_dynamic( const uuid_t uuid );
